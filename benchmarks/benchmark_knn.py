...
def _(mo):
    mo.md(r"""
    # KNeighborsRegressor Benchmarks

    This notebook compares the performance of `rklearn.KNeighborsRegressor` (Rust-based) against `sklearn.neighbors.KNeighborsRegressor`.
...
def _():
    ...
    from rklearn import KNeighborsRegressor as RklearnKNN
